...
export class MentorProfilesHttpService {
  ...
  public getMentorProfiles(): Observable<MentorProfileModel[]> {
    ...
    const model1: MentorProfileModel = {
      ...
      name: 'Sita Ratas',
      mentorshipId: 43,
      profilePicUrl: 'https://cdn.shopify.com/s/files/1/0474/3769/products/love-me-doggie-tea-tea-for-dogs.jpg?v=1479473344',
    ...
    const model5: MentorProfileModel = {
      curriculum: 'Küberkübetaja',
      enabled: true,
      gif: 'http://78.media.tumblr.com/72f0a33d91b3d66f8ef09e7e2ce31c82/tumblr_nx7gsiLvw81uph9ivo1_250.gif',
      id: 1,
    ...
    const model6: MentorProfileModel = {
      curriculum: 'Küberkübetaja',
      enabled: true,
      gif: 'http://78.media.tumblr.com/72f0a33d91b3d66f8ef09e7e2ce31c82/tumblr_nx7gsiLvw81uph9ivo1_250.gif',
      id: 1,
    ...
    const model7: MentorProfileModel = {
      curriculum: 'Küberkübetaja',
      enabled: true,
      gif: 'http://78.media.tumblr.com/72f0a33d91b3d66f8ef09e7e2ce31c82/tumblr_nx7gsiLvw81uph9ivo1_250.gif',
      id: 1,
    ...
    return new Observable<MentorProfileModel[]>((subscriber: Subscriber<MentorProfileModel[]>) =>
      subscriber.next([model1, model2, model3, model4, model6, model5, model7]));
  }
